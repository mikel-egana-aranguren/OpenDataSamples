...
import r01f.types.dirtytrack.internal.ChangesTrackedListMethods;
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    void around(List list,int index,Object value) : 
    			call(public * (@ConvertToDirtyStateTrackable List+).add(int,*))	// llamar al método add de un tipo anotado con @ConvertToDirtyStateTrackable y que extiende de List
    ...
    Object around(List list,int index,Object value) : 
    			call(public * (@ConvertToDirtyStateTrackable List+).set(int,*))	// llamar al método set de un tipo anotado con @ConvertToDirtyStateTrackable y que extiende de List
    ...
    boolean around(List list,int fromIndex,Collection otherCol) : 
    			call(public * (@ConvertToDirtyStateTrackable List+).addAll(int,Collection))		// llamar al método addAll de un tipo anotado con @ConvertToDirtyStateTrackable y que extiende de List
    ...
    Object around(List list,int index) : 
    			call(public * (@ConvertToDirtyStateTrackable List+).remove(int))// llamar al método remove de un tipo anotado con @ConvertToDirtyStateTrackable y que extiende de List
