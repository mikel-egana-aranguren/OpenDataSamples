...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public static class GoogleAPIServiceAccountClientData 
		...
		@Getter private final GoogleAPIClientIDP12KeyPath _p12KeyPath;
	...
	public static class GoogleAPINativeApplicationClientData 
		...
		@Getter private final AppCode _appCode;
		@Getter private final GoogleAPIClientID _clientId;
		@Getter private final GoogleAPIClientIDJsonKeyPath _JsonKeyPath;	
	...
	public static class GoogleAPIClientIDJsonKeyPath
		...
		public static GoogleAPIClientIDJsonKeyPath loadedFromFileSystem(final Path path) {
			return new GoogleAPIClientIDJsonKeyPath(ResourcesLoaderType.FILESYSTEM,
													path);
		}
		public static GoogleAPIClientIDJsonKeyPath loadedFromClassPath(final String path) {
			return new GoogleAPIClientIDJsonKeyPath(ResourcesLoaderType.CLASSPATH,
													path);
		}
		public static GoogleAPIClientIDJsonKeyPath loadedFromFileSystem(final String path) {
			return new GoogleAPIClientIDJsonKeyPath(ResourcesLoaderType.FILESYSTEM,
													path);
		}
	}
	public static class GoogleAPIClientIDP12KeyPath
		...
		public static GoogleAPIClientIDP12KeyPath loadedFromFileSystem(final Path path) {
			return new GoogleAPIClientIDP12KeyPath(ResourcesLoaderType.FILESYSTEM,
												   path);
		}
		public static GoogleAPIClientIDP12KeyPath loadedFromClassPath(final String path) {
			return new GoogleAPIClientIDP12KeyPath(ResourcesLoaderType.CLASSPATH,
												   path);
		}
		public static GoogleAPIClientIDP12KeyPath loadedFromFileSystem(final String path) {
			return new GoogleAPIClientIDP12KeyPath(ResourcesLoaderType.FILESYSTEM,
												   path);
		}
	}
