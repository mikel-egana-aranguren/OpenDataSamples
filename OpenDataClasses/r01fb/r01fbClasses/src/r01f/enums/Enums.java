...
/////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 */
	@GwtIncompatible("GWT does not support reflection")
	public static <E extends Enum<E>> EnumWrapper<E> of(final String theEnumTypeName) {
		Class<E> type = ReflectionUtils.typeFromClassName(theEnumTypeName);
		return new EnumWrapper<E>(type.getEnumConstants(),true);
	}
	/**
	 * Builds an enum wrapper that offers some util with enum
	 * @param theEnumType the enum type
