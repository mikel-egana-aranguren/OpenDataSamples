 ...
 * 			<pre class='brush:java'>
 *	    		I18NService i18n = I18NServiceFactory.create(resBundle)
...
/////////////////////////////////////////////////////////////////////////////////////////
     ...
     */
    public I18NService withMissingKeyBehaviour(final ResourceBundleMissingKeyBehaviour behaviour) {
...
/////////////////////////////////////////////////////////////////////////////////////////
	/**
	 * Encapsula el acceso al objeto {@link ResourceBundle} que es donde están realmente los mensajes y la
	 * caché de mensajes.
	...
	/////////////////////////////////////////////////////////////////////////////////////////
	    ...
	    private ResourceBundle _retrieveBundle(final String bundleName) {
	        ...
	        // IMPORTANTE!!
	        //		- NO CACHEAR el ResourceBoundle ya que si ResourceBundle YA IMPLEMENTA UNA CACHE y además si se cachea se inactiva la opción de recargar en caliente
	        ...
	        //		- CACHEAR el ResourceBundle.Control ya que puede mantener estado sobre la recarga (ej: timeStamp de la última recarga)
	    	ResourceBundle outBundle = ResourceBundle.getBundle(bundleName,_locale,
	    									   	 				_control);
	        return outBundle;
	    }
	}
