 ...
 *		- Si la excepción ha de ser logeada o no
 *		- si ha de ser lanzada "tal cual" (con toda la pila de excepciones) o como una nueva excepción en la que la pila de excepciones se sustituye por un mensaje de texto
 *</pre>
 * The usual usage is:
 * <ul>
 * <li>1.- Create a type extending {@link EnrichedRuntimeException}
 * <pre class='brush:java'>
