...
///////////////////////////////////////////////////////////////////////////////    
    ...
    private volatile int _modCount;		// simplemente se incrementa cada vez que se llama a un metodo mutator de la tabla subyacente
    									// sirve para validar si la tabla se ha modificado cuando se está iterando (ver HashIterator)
...
///////////////////////////////////////////////////////////////////////////////
    ...
    public int size() {
        if (_size == 0) return 0;
        _expungeStaleEntries();		// antes de devolver el tamaño borrar las entradas reclamadas por el GC
        return _size;
    }
    @Override
    ...
    public V get(Object key) {
        ...
        while (e != null) {
            if (e.hash == h && eq(k,e.get())) return e.value;	// varios elementos con el mismo hash están enlazados en una lista
            e = e.next;
        }
        return null;
    }
