...
//	PRIVATE CONSTRUCTOR
//////////////////////////////////////////////////////////////////////////////////////////////
	protected LazyCollectionBase(final Collection<V> backEnd,final CollectionValuesSupplier<V> valuesSupplier) {
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	/**
	 * Returns the underlyng {@link Collection}
	 * @return the {@link Collection}
	 */
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public Set<V> notNewOrRemovedEntries() {
		...
		return  Sets.newHashSet(Collections2.filter(_currentEntries(),
						   							Predicates.not(_changesTracker.newOrDeletedEntriesFilter)));
	}
	@Override
