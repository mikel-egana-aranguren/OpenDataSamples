...
///////////////////////////////////////////////////////////////////////////////		
	...
	static <T> PropertyTypeGenerics<T> newPropertyTypeGenerics(final String name,final TypeRef<T> type) {
...
public static class PropertyTypeGenerics<T> {
	...
	PropertyTypeGenerics(final String name,final TypeRef<T> type) {
		_propertyName = name;
		_propertyType = type;
	}
	/**
