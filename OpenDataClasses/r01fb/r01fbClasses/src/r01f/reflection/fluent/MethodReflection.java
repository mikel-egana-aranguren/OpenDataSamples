...
///////////////////////////////////////////////////////////////////////////////		
	 ...
	 */
	public <T> MethodReturnTypeGenerics<T> withReturnType(final TypeRef<T> type) {
...
///////////////////////////////////////////////////////////////////////////////		
	private static void _validateIsNotNullOrEmpty(final String methodName) {
		if (methodName == null) throw new NullPointerException("The name of the method to access should not be null");
		if (Strings.isNullOrEmpty(methodName)) throw new IllegalArgumentException("The name of the method to access should not be empty");
	}
}