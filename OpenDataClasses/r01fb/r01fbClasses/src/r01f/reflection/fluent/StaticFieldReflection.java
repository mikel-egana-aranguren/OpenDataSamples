...
///////////////////////////////////////////////////////////////////////////////	
	 ...
	 */
	public <T> StaticFieldTypeGenerics<T> ofType(final TypeRef<T> type) {
...
///////////////////////////////////////////////////////////////////////////////	
	private static void _validateIsNotNullOrEmpty(final String fieldName) {
		if (fieldName == null) throw new NullPointerException("The name of the static field to access should not be null");
		if (Strings.isNullOrEmpty(fieldName)) throw new IllegalArgumentException("The name of the static field to access should not be empty");
	}
}