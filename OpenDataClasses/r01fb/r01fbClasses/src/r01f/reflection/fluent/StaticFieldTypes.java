...
///////////////////////////////////////////////////////////////////////////////	
	...
	static <T> StaticFieldTypeGenerics<T> newFieldTypeGenerics(final String fieldName,final TypeRef<T> fieldType) {
		if (fieldType == null)
...
public static class StaticFieldTypeGenerics<T> {
	...
	StaticFieldTypeGenerics(final String fieldName,final TypeRef<T> fieldType) {
		_fieldName = fieldName;
		_fieldType = fieldType;
	}	
	/**
