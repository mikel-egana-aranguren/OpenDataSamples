...
@XmlRootElement(name="mediaQuery")
@Accessors(prefix="_")
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	@Getter @Setter(AccessLevel.PRIVATE) private Map<String,MediaQueryValue<?>> _values;
/////////////////////////////////////////////////////////////////////////////////////////
//  BUILDER
/////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////
	private <T> void _putValue(final MediaQueryValue<T> value,
		...
		if (_values == null) _values = new LinkedHashMap<String,MediaQueryValue<?>>();
		if (CollectionUtils.hasData(valuesToExcludeIfPresent)) {
			for (String valToExclude : valuesToExcludeIfPresent) {
				_values.remove(valToExclude);
			}
		}
		_values.put(value.getName(),
					value);
	}
/////////////////////////////////////////////////////////////////////////////////////////
//  
/////////////////////////////////////////////////////////////////////////////////////////
	public static String toMediaQueryString(Collection<MediaQuery> orCombinedMediaQueries) {
	...
	private static String _mediaQueryToString(final MediaQuery mediaQuery) {
		...
		if (CollectionUtils.hasData(mediaQuery.getValues())) {
			valuesToString = new StringBuilder(mediaQuery.getValues().size() * 30);
			for (Iterator<MediaQueryValue<?>> valIt = mediaQuery.getValues().values().iterator(); valIt.hasNext(); ) {
				MediaQueryValue<?> val = valIt.next();
				valuesToString.append(val.asString());
				if (valIt.hasNext()) valuesToString.append(" AND ");
			}
		}
		return Strings.of("{} AND {}")
					  .customizeWith(mediaQuery.getDevice().name().toLowerCase(),
							  		 valuesToString)
					  .asString();
	}
/////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	private class MediaQueryValue<T>
