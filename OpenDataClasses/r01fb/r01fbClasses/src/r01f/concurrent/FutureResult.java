...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public FutureResult(final AsyncCallBack<T> callBack) {
		this();
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public T result() {
		switch (_state) {
		case INCOMPLETE:
			throw ExecutionException.becauseOfIncompleteResult();
		case FAILED: 
			throw ExecutionException.becauseOfExecutionException(_exception);
		case CANCELLED:
			throw ExecutionException.becauseOfRequestCancellation();
		case SUCCEEDED:
			return _value;
		default:
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	protected void cancel() {
		...
		_exception = ExecutionException.becauseOfRequestCancellation();
...
/////////////////////////////////////////////////////////////////////////////////////////
	public String getName() {
		return (_name != null && !_name.isEmpty()) ? _name 
												   : Strings.of("FutureResult<{}>")
												   			.customizeWith(_value != null ? _composeSimpleName(_value.getClass()) : "?")
												   			.asString();
	}
