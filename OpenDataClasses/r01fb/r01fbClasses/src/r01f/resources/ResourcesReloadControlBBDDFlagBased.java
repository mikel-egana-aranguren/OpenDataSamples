...
/**
 * Implementación de la política de recarga de propiedades en base a un token en BBDD.<br>
 * <p>En los parámetros de configuración de la política de recarga se ha de identificar:<br>
 * <ul>
 * 		<li>El dataSource para obtener la conexión con la BBDD.</li>
 * 		<li>El nombre de la tabla y columna que contienen el TimeStamp de última modificación de las propiedades.</li>
 * 		<li>El periodo de comprobación de la recarga
 * 	  		(el sistema comprueba la del TimeStamp y si es POSTERIOR a la última vez que se revisó este TimeStamp, recarga las propiedades).</li>
 * </ul>
 ...
 * 			</reloadFlagQuerySql>
 * 			<reloadFlagUpdateSql>
 * 				<!-- Actualización del flag, para desactivarlo. -->
 * 				<![CDATA[
