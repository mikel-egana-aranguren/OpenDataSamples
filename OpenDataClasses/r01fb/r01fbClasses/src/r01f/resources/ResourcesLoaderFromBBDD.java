 ...
 * 
 * Propiedades con la información de conexión a la Base de Datos,
 * la query de consulta del fichero de propiedades y la columna que contiene el fichero.
 *
 * <p>Ejemplo de conexión vía JDBC a la Base de datos:
 * <pre class="brush:xml">
 ...
 *				la consulta se realizará a través de dicho alias. Solamente se consulta la versión activa, y además esta
 *				debe ser única. -->
 *			<![CDATA[
 ...
 *		</query>
 * 		<updatets>
 * 			<!-- Actualización de la fecha con la última recarga. -->
 * 			<![CDATA[
 ...
 * 		</updatets>
 * 	</props>
 * 	<reloadControl><!-- Definición del control de la recarga. --></reloadControl>
 * </resourcesLoader>
 * </pre>
 *
 * <p>Ejemplo de conexión con Datasource:
 * <pre class="brush:xml">
 * <resourcesLoader type='BBDD'>
 * 	<props>
 ...
 *			<!-- Query para obtener el fichero de propiedades de la base de datos, OBLIGATORIAMENTE se
 *				debe definir un alias llamado PROPERTIES_XML para obtener el campo que almacena las propiedades,
 *				la consulta se realizará a través de dicho alias. -->
 *			<![CDATA[
 *				SELECT DATA_01 AS PROPERTIES_XML
 *				    FROM PROPERTIES_CFG
 *				  WHERE COD_APLIC_01 = 'r01f'
...
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    public InputStream getInputStream(final String resourceName,
		...
		if (!_dbConnectionProps.containsKey("query")) {
			throw new IllegalStateException("Revisar la definición del componente cuyo 'resourcesLoader' debe contener una propiedad denominada 'query' con la query " +
	...
	private void _updateReloadTS() {
		if(!_dbConnectionProps.containsKey("updatets")) {
			throw new IllegalStateException("Revisar la definición del componente cuyo 'resourcesLoader' debe contener una propiedad denominada 'updatets' con " +
					 						"la update para la actualización de la fecha con la última recarga del fichero de propiedades.");
		}
