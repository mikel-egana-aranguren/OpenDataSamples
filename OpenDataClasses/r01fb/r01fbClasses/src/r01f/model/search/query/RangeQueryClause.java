...
import r01f.model.search.query.QueryClauseXMLMarshallers.RangeQueryXMLCustomMarshallers;
...
@Inmutable	
@XmlRootElement(name="rangeClause") @XmlReadTransformer(using=RangeQueryXMLCustomMarshallers.class) @XmlWriteTransformer(using=RangeQueryXMLCustomMarshallers.class)
@Accessors(prefix="_")
@NoArgsConstructor
