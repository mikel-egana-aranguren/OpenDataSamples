...
///////////////////////////////////////////////////////////////////////////////////////////        
    ...
    @Getter private final long _itemCount; 			// Total number of items found
    @Getter private final long _pageCount;			// number of pages
    
    @Getter private long _currentPage;  				// Current page
    @Getter private long[] _currentPageItems;			// Current page items
    @Getter private long[] _currentNavBarWindowPages;	// Current window pages
///////////////////////////////////////////////////////////////////////////////////////////
//  CONSTRUCTORS
///////////////////////////////////////////////////////////////////////////////////////////
    /** 
    ...
    public Paging(final int totalItems,
    			  final long currPage) throws IllegalArgumentException {
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void _computeState() {
        ...
        long navBarWindows = this.getNavBarWindowsCount();			// the number of nav bar windows        
        long currentNavNarWindow = this.getCurrentNavBarWindow();	// the current nav bar window
        
        int currentWindowItems = currentNavNarWindow < navBarWindows || _pageCount % _navBarWindowItems == 0 ? _navBarWindowItems
        															 									 : (int)_pageCount % _navBarWindowItems;
        // Return an array of the item numbers of the current window
        long currentNavBarWindowItem = currentNavNarWindow > 1 ? currentNavNarWindow * _navBarWindowItems - _navBarWindowItems + 1
        													   : 1;
        long[] windowItems = new long[currentWindowItems];
        ...
        long pageFirstItem = this.getPageFirstItem(_currentPage);
        long pageLastItem = this.getPageLastItem(_currentPage);
        int pagesInWindow = (int)(pageLastItem - pageFirstItem) + 1;
        _currentPageItems = new long[pagesInWindow];
...
/////////////////////////////////////////////////////////////////////////////////////////
     ...
     */
    public long getCurrentPageFirstItem() {
     ...
     */
    public long getCurrentPageLastItem() {
     ...
     */
    public long getPreviousPageLastItem() {
     ...
     */   
    public long getNextPageFirstItem() {
     ...
     * @return 
     */
    public long getPageFirstItem(final long page) throws IllegalArgumentException {
        if (page < 1 || page > _pageCount) throw new IllegalArgumentException("Illegal page");
        if (page == this.getFirstPage()) return 1;
        return (page * _pageItems) - _pageItems + 1;
    }
    /**
     ...
     * @return
     */
    public long getPageLastItem(final long page) throws IllegalArgumentException {
        if (page < 1 || page > _pageCount) throw new IllegalArgumentException("Illegal page");
        if (page == this.getLastPage() && _itemCount % _pageItems != 0) {
        	int lastPageItems = (int)_itemCount % _pageItems;
...
///////////////////////////////////////////////////////////////////////////////////////////
     ...
     * @return
     */
    public long getNavBarWindowsCount() {
        long navBarWindows = _pageCount / _navBarWindowItems + (_pageCount % _navBarWindowItems != 0 ? 1 : 0);
     ...
     * @return
     */
    public long getCurrentNavBarWindow() {
        long currentNavNarWindow = _currentPage / _navBarWindowItems + (_currentPage % _navBarWindowItems != 0 ? 1 : 0); 
     ...
     * @return
     */
    public long getCurrentNavBarWindowFirstPage() {
     ...
     * @return
     */
    public long getCurrentNavBarWindowLastPage() {
     ...
     * @return
     */
    public long getPrevNavBarWindowLastPage() {
        long prevBlockLastPage = _currentNavBarWindowPages[0] == 1 ? 1 : _currentNavBarWindowPages[0]-1;
     ...
     * @return
     */
    public long getNextNavBarWindowFirstPage() {
        long nextBlockFirstPage = _currentNavBarWindowPages[_currentNavBarWindowPages.length-1] == _pageCount ? _currentNavBarWindowPages[_currentNavBarWindowPages.length-1]
...
///////////////////////////////////////////////////////////////////////////////////////////
     ...
     */
    public void goToPage(long newPage) throws IllegalArgumentException {       
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public class PagingItem
      implements Debuggable {
    	@Getter private final long _page;
    	@Getter private final long _pageFirstItem;
    	@Getter private final long _pageLastItem;
    	
    	@Getter private final long _window;
    	@Getter private final long _windowFirstPage;
    	@Getter private final long _windowLastPage;
		...
		public CharSequence debugInfo() {
			...
			sb.append(Strings.customized("Window {} ({}-{})",
										 ...
										 _windowFirstPage,
										 _windowLastPage));
			int windowPageNum = (int)(_windowLastPage - _windowFirstPage); 
			sb.append(" [");
