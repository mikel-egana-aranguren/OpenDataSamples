...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public static <T> T pickOneAndOnlyElement(final Collection<?> theCol,
    	...
    	if (CollectionUtils.isNullOrEmpty(theCol)) throw new IllegalStateException("The collection is null or empty");
		if (theCol.size() > 1) throw new IllegalStateException(Throwables.message(errMsg,vars));
		return CollectionUtils.<T>pickOneElement(theCol);
	}
	/**
	 * Picks the one and only element from the collection
...
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static boolean isMapOrCollection(final Class<?> type) {
    	return ReflectionUtils.isImplementing(type,Map.class) | ReflectionUtils.isImplementing(type,Collection.class);
    }
    /**
     ...
     * @param obj el objeto que se supone que es una colección
     * @return List.class si el objeto es una lista, Map.class si el objeto es un mapa o null si no es ni lista ni mapa
     */
	@GwtIncompatible("uses reflection which is NOT supported by GWT")
...
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static <T> T[] toArray(final Collection<T> col) {
    	TypeRef<T> tr = new TypeRef<T>() {/* nothing */};
		T[] outArray = CollectionUtils.hasData(col) ? col.toArray((T[])Array.newInstance(tr.rawType(),col.size()))
    												: null;
    	return outArray;
    }
    @GwtIncompatible("Array NOT supported by GWT")
    ...
    @GwtIncompatible("Array NOT supported by GWT")
    @SuppressWarnings("unchecked")
	public static <T> T[] toArray(final Collection<T> col,final TypeRef<T> typeRef) {
