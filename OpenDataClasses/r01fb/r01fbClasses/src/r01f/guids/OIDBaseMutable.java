 ...
 * The difference with the normal {@link OIDBaseInmutable} is that the encapsulated id is NOT final
 ...
 */
@Inmutable	// the object is immutable (but underneath it's mutable... so it's name is OIDBaseMutable
@Accessors(prefix="_")
