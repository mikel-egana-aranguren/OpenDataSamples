...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public String process(final SassOptions sassOptions,
		...
		try {
			String sassSource = Strings.of(sassSourceReader)
							     	   .asString();
			try {
				...
				if (scriptEx.getLineNumber() > 0 && scriptEx.getColumnNumber() > 0) {
					procEx = new ProcessorException(Strings.of("Error while processing SASS compile ruby script at line {} column {}: {}")
														   .customizeWith(scriptEx.getLineNumber(),scriptEx.getColumnNumber(),
																	      scriptEx.getMessage())
														   .asString(),
												 scriptEx);
				} else {
